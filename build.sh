...
if command -v cargo >/dev/null 2>&1; then
	...
	register rust "${BINDIR}/getshells-rust" "${SRCDIR}/getshells_rust/src/main.rs"
fi
...
if command -v go >/dev/null 2>&1; then
	...
	register go "${BINDIR}/getshells-go" "${SRCDIR}/getshells.go"
fi
...
if command -v gfortran >/dev/null 2>&1; then
	...
	register fortran "${BINDIR}/getshells-fortran" "${SRCDIR}/getshells.f90"
fi
...
if command -v sbcl >/dev/null 2>&1; then
	...
	register lisp "${BINDIR}/getshells-lisp" "${SRCDIR}/getshells.lisp"
fi
...
if command -v crystal >/dev/null 2>&1; then
	...
	register crystal "${BINDIR}/getshells-cr" "${SRCDIR}/getshells.cr"
fi
...
if command -v ghc >/dev/null 2>&1; then
	...
	register haskell "${BINDIR}/getshells-hs" "${SRCDIR}/getshells.hs"
fi
...
if command -v python3 >/dev/null 2>&1; then
	...
	register python "${BINDIR}/getshells-py" "${SRCDIR}/getshells.py"
fi
...
if command -v ruby >/dev/null 2>&1; then
	...
	register ruby "${BINDIR}/getshells-rb" "${SRCDIR}/getshells.rb"
fi

if command -v php >/dev/null 2>&1; then
	log WRAP PHP
	make_wrapper getshells-php php getshells.php
	register php "${BINDIR}/getshells-php" "${SRCDIR}/getshells.php"
fi

if command -v node >/dev/null 2>&1; then
	log WRAP NodeJS
	make_wrapper getshells-js node getshells.js
	register nodejs "${BINDIR}/getshells-js" "${SRCDIR}/getshells.js"
fi

if command -v julia >/dev/null 2>&1; then
	log WRAP Julia
	make_wrapper getshells-jl julia getshells.jl
	register julia "${BINDIR}/getshells-jl" "${SRCDIR}/getshells.jl"
fi

if command -v lua >/dev/null 2>&1; then
	log WRAP Lua
	make_wrapper getshells-lua lua getshells.lua
	register lua "${BINDIR}/getshells-lua" "${SRCDIR}/getshells.lua"
fi

if command -v luajit >/dev/null 2>&1; then
	log WRAP LuaJIT
	make_wrapper getshells-luajit luajit getshells.lua
	register luajit "${BINDIR}/getshells-luajit" "${SRCDIR}/getshells.lua"
fi

if command -v awk >/dev/null 2>&1; then
	log WRAP Awk
	make_wrapper getshells-awk sh getshells.awk
	register awk "${BINDIR}/getshells-awk" "${SRCDIR}/getshells.awk"
fi

if command -v pwsh >/dev/null 2>&1; then
	log WRAP PowerShell
	make_wrapper getshells-ps1 pwsh getshells.ps1
	register powershell "${BINDIR}/getshells-ps1" "${SRCDIR}/getshells.ps1"
fi

if command -v elixir >/dev/null 2>&1; then
	log WRAP Elixir
	make_wrapper getshells-exs elixir getshells.exs
	register elixir "${BINDIR}/getshells-exs" "${SRCDIR}/getshells.exs"
fi

if command -v clojure >/dev/null 2>&1; then
	log WRAP Clojure
	make_wrapper getshells-clj clojure getshells.clj
	register clojure "${BINDIR}/getshells-clj" "${SRCDIR}/getshells.clj"
fi

if command -v bb >/dev/null 2>&1; then
	log WRAP Babashka
	make_wrapper getshells-bb bb getshells-bb.clj
	register babashka "${BINDIR}/getshells-bb" "${SRCDIR}/getshells-bb.clj"
fi

if command -v guile >/dev/null 2>&1; then
	log WRAP Guile
	make_wrapper_args getshells-guile getshells-guile.scm guile -s
	register guile "${BINDIR}/getshells-guile" "${SRCDIR}/getshells-guile.scm"

	log WRAP Scheme
	make_wrapper_args getshells-scheme getshells.scm guile -s
	register scheme "${BINDIR}/getshells-scheme" "${SRCDIR}/getshells.scm"
fi

if command -v raku >/dev/null 2>&1; then
	log WRAP Raku
	make_wrapper getshells-raku raku getshells.raku
	register raku "${BINDIR}/getshells-raku" "${SRCDIR}/getshells.raku"
fi
